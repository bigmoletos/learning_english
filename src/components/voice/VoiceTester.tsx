      ...
      <CardContent>
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            Testez différentes voix Google Cloud TTS et vérifiez leur sélection dans les logs du
            navigateur.
          </Typography>
        </Box>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Box sx={{ display: "flex", gap: 1, mb: 2, flexWrap: "wrap" }}>
                <Chip label={`Voix: ${selectedVoice}`} color="primary" size="small" />
                <Chip
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                <Typography variant="caption">
                  Ouvrez la console du navigateur (F12) pour voir les logs détaillés de sélection de
                  voix.
                </Typography>
              </Alert>
            </Box>
          ...
          <Typography variant="body2" component="div">
            <ol>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <code>[AudioPlayer] Changement de voix</code>
                  </li>
                  <li>
                    <code>[GoogleTTS] Mapping voix</code>
                  </li>
                  <li>
                    <code>[GoogleTTS] Voix mappée trouvée</code>
                  </li>
                  <li>
                    <code>[GoogleTTS] Voix US disponibles</code>
                  </li>
                </ul>
              </li>
              <li>
                Testez différentes voix pour vérifier que chaque sélection utilise bien une voix
                différente
              </li>
            </ol>
          </Typography>
